...
import thankyou from "../assets/images/amr hero3.jpg";

export default function PopupForm({ title, closePopup }) {

  const primaryColor = "#d85b26d6";   // changed color
  ...
  return (
    <div style={overlay}>
      ...
      <div style={popup} className="popup-card">
        ...
        {/* HEADER */}
        <div style={{ ...header, background: primaryColor }}>
          {title}
        ...
        {!submitted ? (
          ...
          <div style={body}>
            ...
            <div className="left-panel" style={leftPanel}>
              ...
              <h3 style={{ color: primaryColor }}>We Promise</h3>
            ...
            <div style={formPanel} className="form-panel">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <select style={input} required>
                  <option value="">Select Unit Type*</option>
                  <option value="3bhk">3 BHK — ₹1.69 Cr*</option>
                  <option value="3.5bhk">3.5 BHK — ₹1.89 Cr*</option>
                  <option value="4bhk">4 BHK — ₹3.1 Cr*</option>
                  <option value="4.5bhk">4.5 BHK — ₹3.3 Cr*</option>
                </select>
            ...
            {/* RIGHT PANEL */}
            <div className="right-panel" style={{ ...rightPanel, background: primaryColor }}>
          ...
          >
            ...
            <div
              style={{
                background: "rgba(207, 151, 31, 0.96)",
                padding: "30px 40px",
                borderRadius: "6px"
              }}
            >
...
const submitBtn = {
  background: "#d85b26",   // changed color
  border: "none",
  color: "#fff",
  padding: "12px 30px",
  cursor: "pointer",
