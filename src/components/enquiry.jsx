...
height:72px;
border-radius:50%;
background:linear-gradient(135deg,#c8962b,#e8b84b);
display:flex;
align-items:center;
justify-content:center;
margin-bottom:18px;
box-shadow:0 6px 20px rgba(200,150,43,0.35);
}
      ...
      <aside className="enq-card">
        ...
        {submitted ? (
          <div className="enq-thankyou">
            <div className="enq-thankyou-circle">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                <polyline
                  className="enq-thankyou-check"
          ...
          <div className="enq-form-section">
            ...
            <button className="enq-btn-submit" onClick={handleSubmit}>Submit</button>
            <p className="enq-safe-text">Your information is safe with us.</p>
          </div>
        )}
